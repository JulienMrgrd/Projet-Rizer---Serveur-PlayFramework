...
public class GracenoteWebAPI
{
    ...
    public String register() throws GracenoteException 
    {
        return this.register(this._clientID + "-" + this._clientTag);
    }

    public String register(String clientID) throws GracenoteException 
    {
    ...
    public GracenoteMetadata searchTrack(String artistName, String albumTitle, String trackTitle) throws GracenoteException
    {
        // Sanity check
    ...
    public GracenoteMetadata searchArtist(String artistName) throws GracenoteException
    {
        return this.searchTrack(artistName,  "", "");
    }

    // Queries the Gracenote service for an album.
    public GracenoteMetadata searchAlbum(String artistName, String albumTitle) throws GracenoteException
    {
    ...
    public Document fetchAlbumWithoutParsing(String gn_id) throws GracenoteException 
    {
        // Sanity check
        if (this._userID.equals("")) { this.register(); }
    ...
    protected GracenoteMetadata _execute(String data) throws GracenoteException 
    {
        String response = this._httpPostRequest(this._apiURL, data);
    ...
    private Document _checkResponse(String response) throws GracenoteException
    {
        ...
        {
            if( e instanceof GracenoteException ) throw ((GracenoteException) e);
        	e.printStackTrace();
        }
    ...
    protected GracenoteMetadata _parseResponse(String response) throws GracenoteException 
    {
        Document xml = null;
        try{
